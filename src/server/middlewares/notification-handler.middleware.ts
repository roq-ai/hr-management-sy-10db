...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'selected_mp3_players.create': {
    roles: ['owner'],
    key: 'mp3-player-added',
    tenantPath: ['organization', 'user', 'selected_mp3_players'],
    userPath: [],
  },
  'selected_mp3_players.delete': {
    roles: ['owner'],
    key: 'mp3-player-removed',
    tenantPath: ['organization', 'user', 'selected_mp3_players'],
    userPath: [],
  },
  'favorite_songs.create': {
    roles: ['owner'],
    key: 'song-added-to-favorites',
    tenantPath: ['organization', 'user', 'favorite_songs'],
    userPath: [],
  },
  'favorite_songs.delete': {
    roles: ['owner'],
    key: 'song-removed-from-favorites',
    tenantPath: ['organization', 'user', 'favorite_songs'],
    userPath: [],
  },
};
