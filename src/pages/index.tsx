  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management System: Elevating your music experience. Find your perfect MP3 player, discover artists and titles effortlessly, and enjoy your favorite songs like never before."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management System: Elevating your music experience. Find your perfect MP3 player, discover artists and titles effortlessly, and enjoy your favorite songs like never before.`}
            </Text>
            <Box
