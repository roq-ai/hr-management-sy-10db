...
import { getSelectedMp3PlayersById } from 'apiSdk/selected-mp-3-players';
import { SelectedMp3PlayersInterface } from 'interfaces/selected-mp-3-players';

function SelectedMp3PlayersViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Selected Mp 3 Players Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                <Box>
                  ...
                  >
                    Selected Mp 3 Players Details
                  </Text>
                </Box>
                {hasAccess('selected_mp_3_players', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/selected-mp-3-players/edit/${id}`} passHref legacyBehavior>
                    <Button
